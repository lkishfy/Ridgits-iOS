...
enum RidgitsColors {
    ...
    static let optionBorder = Color(hex: 0xCCCCCC)
    ...
    /// Trie marketing accent (homepage gooey CTA — #c7e64c)
    static let trieAccent = Color(hex: 0xC7E64C)
    static let trieAccentDark = Color(hex: 0x5A6618)
    /// Forest green for nearby-match teasers and location prompts.
    static let forestGreen = Color(hex: 0x2D6A4F)
    static let forestGreenDark = Color(hex: 0x1B4332)
    static let forestGreenLight = Color(hex: 0xD8EDDF)
    static let pokeOrange = Color(hex: 0xEA580C)
